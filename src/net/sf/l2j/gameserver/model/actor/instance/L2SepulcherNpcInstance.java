...
public class L2SepulcherNpcInstance extends L2NpcInstance {
    ...
    private void doAction(L2PcInstance player) {
        ...
        switch (getNpcId()) {
            ...
            case 31487:
                ...
                _spawnMonsterTask = EffectTaskManager.getInstance().schedule(new SpawnMonster(getNpcId()), 3500);
                break;
    ...
    public void openNextDoor(int npcId) {
        ...
        _closeTask = EffectTaskManager.getInstance().schedule(new CloseNextDoor(doorId), 10000);
        if (_spawnNextMysteriousBoxTask != null) {
            _spawnNextMysteriousBoxTask.cancel(true);
        }
        _spawnNextMysteriousBoxTask = EffectTaskManager.getInstance().schedule(new SpawnNextMysteriousBox(npcId), 0);
    }
