...
public class L2BoatInstance extends L2Character
{
	...
	private static class L2BoatTrajet
	{
	...
	public void begin()
	{
		if(_cycle == 1)
		{
			FastList<L2PcInstance> knownPlayers = getKnownList().getKnownPlayersInRadius(1500);
			if (knownPlayers != null && !knownPlayers.isEmpty())
			{
	...
	{
		FastList<L2PcInstance> knownPlayers = getKnownList().getKnownPlayersInRadius(2500);
		CreatureSay sm;
		PlaySound ps;
		switch(i)
		{
