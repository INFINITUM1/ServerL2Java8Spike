...
public class ObjectKnownList {
    ...
    private Map<Integer, L2Object> _knownObjects = new ConcurrentHashMap<Integer, L2Object>();
            ...
            if (!object.isVisible()
                ...
                if (object instanceof L2BoatInstance && getActiveObject().isPlayer()) {
                    if (((L2BoatInstance) (object)).getVehicleDeparture() == null) {
                        //
                    } else if (getActiveObject().isInBoat()) {
                        if (getActiveObject().getBoat() == object) {
                            //
                        } else {
                            removeKnownObject(object);
                        }
    ...
    public final Map<Integer, L2Object> getKnownObjects() {
        ...
        //if (_knownObjects == null) _knownObjects = new FastMap<Integer, L2Object>().shared("ObjectKnownList._knownObjects");
    ...
    public final FastList<L2DoorInstance> getKnownDoors() {
        FastList<L2DoorInstance> result = new FastList<L2DoorInstance>();
