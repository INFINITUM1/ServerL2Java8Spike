...
public enum ClassId {
    ...
    orcMage(0x31, true, Race.orc, null), orcShaman(0x32, true, Race.orc, orcMage), overlord(0x33, true,
    ...
    titan(0x71, false, Race.orc, destroyer), grandKhauatari(0x72, false, Race.orc, tyrant),
     ...
     */
    HellParent(0x77, false, Race.human, null),
    HellAssassin(0x78, false, Race.human, HellParent),
    HellWarrior(0x79, false, Race.human, HellParent),
    HellWizard(0x7a, false, Race.human, HellParent),
    HellTank(0x7b, false, Race.human, HellParent),
    HellHealer(0x7c, false, Race.human, HellParent);
