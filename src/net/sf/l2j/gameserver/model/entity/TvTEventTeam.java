...
public class TvTEventTeam {
     ...
     */
    private FastList<Location> _coordinates = new FastList<Location>();
    /**
     ...
     */
    public TvTEventTeam(String name, FastList<Location> coordinates) {
        _name = name;
    ...
    public Location getCoordinates() {
        //return _coordinates;
        return _coordinates.get(Rnd.get(_coordinates.size() - 1));
    }
