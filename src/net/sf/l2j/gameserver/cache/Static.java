...
public final class Static {
    ...
    public static final SystemMessage A_PRIVATE_STORE_MAY_NOT_BE_OPENED_WHILE_USING_A_SKILL = SystemMessage.id(SystemMessageId.A_PRIVATE_STORE_MAY_NOT_BE_OPENED_WHILE_USING_A_SKILL);
    ...
    public static final SystemMessage ANOTHER_LOGIN_WITH_ACCOUNT = SystemMessage.id(SystemMessageId.ANOTHER_LOGIN_WITH_ACCOUNT);
    public static final SystemMessage SKILL_READY_TO_USE_AGAIN = SystemMessage.id(SystemMessageId.SKILL_READY_TO_USE_AGAIN);
    public static final SystemMessage WAREHOUSE_TOO_FAR = SystemMessage.id(SystemMessageId.WAREHOUSE_TOO_FAR);
    public static final SystemMessage PACKAGE_SEND_DONE = SystemMessage.id(SystemMessageId.PACKAGE_SEND_DONE);
    public static final SystemMessage PACKAGE_SEND_ERROR = SystemMessage.id(SystemMessageId.PACKAGE_SEND_ERROR);
    public static final SystemMessage PACKAGE_SEND_ERROR_TOO_FAR = SystemMessage.id(SystemMessageId.PACKAGE_SEND_ERROR_TOO_FAR);
    //
    ...
    public static final SystemMessage FORBIDDEN_LIGHT_CLASS = SystemMessage.id(SystemMessageId.S1_S2).addString("Вашему классу запрещено одевать LIGHT сет.");
    public static final SystemMessage FORBIDDEN_MAGIC_CLASS = SystemMessage.id(SystemMessageId.S1_S2).addString("Вашему классу запрещено одевать MAGIC сет.");
    public static final SystemMessage FORBIDDEN_HEAVY_CLASS = SystemMessage.id(SystemMessageId.S1_S2).addString("Вашему классу запрещено одевать HEAVY сет.");
    public static final SystemMessage FORBIDDEN_SHIELD_CLASS = SystemMessage.id(SystemMessageId.S1_S2).addString("Вашему классу запрещено одевать SHIELD.");
    ...
    public static final SystemMessage FORBIDDEN_BOW_CLASS_OLY = SystemMessage.id(SystemMessageId.S1_S2).addString("Вашему классу запрещено использовать лук на олимпиаде.");
    public static final SystemMessage FORBIDDEN_FIST_CLASS = SystemMessage.id(SystemMessageId.S1_S2).addString("Вашему классу запрещено использовать кастеты.");
    public static final SystemMessage FORBIDDEN_DUAL_CLASS = SystemMessage.id(SystemMessageId.S1_S2).addString("Вашему классу запрещено использовать дуалы.");
    ...
    public static final SystemMessage CANNOT_FISH_BEHIND = SystemMessage.id(SystemMessageId.S1_S2).addString("Подойдите ближе к воде или встаньте лицом к воде.");
    public static final SystemMessage NOT_OWN_CLANNPC = SystemMessage.id(SystemMessageId.S1_S2).addString("Ваш клан не владеет уникальным НПЦ.");
    public static final SystemMessage CANT_LOGOUT_ZONE = SystemMessage.id(SystemMessageId.S1_S2).addString("В данной местности нельзя выйти из игры.");
    public static final SystemMessage DISABLED = SystemMessage.id(SystemMessageId.S1_S2).addString("Отключено.");
    public static final SystemMessage RES_DISABLED = SystemMessage.id(SystemMessageId.S1_S2).addString("Нельзя использовать в данной зоне.");
    public static final SystemMessage EVENT_PASS = SystemMessage.id(SystemMessageId.S1_S2).addString("Вы отказались от участия в ивенте.");
    public static final SystemMessage PREMIUM_ONLY = SystemMessage.id(SystemMessageId.S1_S2).addString("Извините, у Вас не активирован премиум.");
    public static final SystemMessage SIEGE_DISABLED = SystemMessage.id(SystemMessageId.S1_S2).addString("Осада данного замка отключена.");
    public static final SystemMessage TELETO_RB = SystemMessage.id(SystemMessageId.S1_S2).addString("Вы отказались от телепорта.");
    //
    ...
    public static SystemMessage CHAT_LEVEL_PENALTY;
    ...
    public static NpcHtmlMessage PARA_WELCOME;
    public static NpcHtmlMessage MULTISELL_TICKET;
    //
    ...
    public static String SHOP_FOR_PREMIUM;
    public static String CLAN_GAINED_S1_NPCPOINTS;
    public static String CASTLE_LORD_LOGIN;
    public static String BE_STARTED;
    public static String BE_TIME_LEFT;
    public static String BE_FINISHED;
    ...
    public static void init() {
        ...
        CHAT_LEVEL_PENALTY = SystemMessage.id(SystemMessageId.S1_S2).addString("Чат доступен с " + Config.CHAT_LEVEL + " уровня.");
        ...
        SHOP_FOR_PREMIUM = CustomServerData.getInstance().getMessage(176);
        CLAN_GAINED_S1_NPCPOINTS = CustomServerData.getInstance().getMessage(177);
        CASTLE_LORD_LOGIN = CustomServerData.getInstance().getMessage(181);
        BE_STARTED = CustomServerData.getInstance().getMessage(182);
        BE_TIME_LEFT = CustomServerData.getInstance().getMessage(183);
        BE_FINISHED = CustomServerData.getInstance().getMessage(184);
    ...
    public static void updateHtm() {
        ...
        if (Config.HTMPARA_WELCOME) {
            PARA_WELCOME = NpcHtmlMessage.id(0);
            PARA_WELCOME.setFile("data/html/welcome_para.htm");
        }
        ...
        if (!Config.MULTVIP_CARDS.isEmpty()) {
            MULTISELL_TICKET = NpcHtmlMessage.id(0);
            MULTISELL_TICKET.setFile("data/html/mult_ticket.htm");
        }
    }
}
