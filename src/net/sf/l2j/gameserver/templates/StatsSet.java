...
{
	private final FastMap<String, Object> _set = new FastMap<String, Object>().shared("StatsSet._set");
    ...
    public void add(StatsSet newSet)
    {
		...
		for (FastMap.Entry<String, Object> e = newMap.head(), end = newMap.tail(); (e = e.getNext()) != end;) 
		{
			//String key = e.getKey(); // No typecast necessary.
			//Object value = e.getValue(); // No typecast necessary.
            _set.put(e.getKey(), e.getValue());
		}
    }
