...
{
	private static final Logger _log = AbstractLogger.getLogger(BoatManager.class.getName());
	...
	private final void load()
	{
		...
		{
			_initialized = false;
			_log.warning("BoatManager [ERROR]: boat.csv is missing in data folder");
		}
		catch (Exception e)
		{
			_initialized = false;
			_log.warning("BoatManager [ERROR]: creating boat table " + e);
			e.printStackTrace();
		}
		finally
		{
