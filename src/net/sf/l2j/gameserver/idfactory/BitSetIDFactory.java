...
public class BitSetIDFactory extends IdFactory {
    ...
    private static final Logger _log = AbstractLogger.getLogger(BitSetIDFactory.class.getName());
    ...
    public synchronized int getNextId() {
        ...
        if (nextFree < 0) {
            if (_freeIds.size() < FREE_OBJECT_ID_SIZE) {
                ...
                // throw new NullPointerException("idfactory\BitSetIDFactory.java Ran out of valid Id's.");
            }
        }
