...
public class SellList extends L2GameServerPacket
{
	...
	protected final void writeImpl()
	{
		...
		for (L2ItemInstance item : _selllist)
		{
			...
			if (_lease == null)
				writeD(item.getItem().getReferencePrice()); // wtf??? there is no conditional part in SellList!! this d should allways be here 0.o! fortunately the lease stuff are never ever use so the if allways exectues
		}
	}
