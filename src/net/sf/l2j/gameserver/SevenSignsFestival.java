    ...
    */
        ...
        try
        {
        	...
        	for (Map<Integer, StatsSet> currCycleData : _festivalData.values())
	        {
	            for (StatsSet festivalDat : currCycleData.values())
	            {
	                ...
	                st.setLong(1, Long.valueOf(festivalDat.getString("date")));
	                ...
	                st.setLong(4, Long.valueOf(festivalDat.getString("date")));
    ...
    private void addReputationPointsForPartyMemberClan(String partyMemberName)
    {
		...
		else
		{
        	...
        	{
        		con = L2DatabaseFactory.get();
        		st = con.prepareStatement(GET_CLAN_NAME);
    ...
    public final int getMinsToNextCycle()
    {
        ...
        return Math.round((long)(_nextFestivalCycleStart - System.currentTimeMillis()) / 60000);
    }
    ...
    public final int getMinsToNextFestival()
    {
        ...
        return Math.round((long)(_nextFestivalStart - System.currentTimeMillis()) / 60000) + 1;
    }
