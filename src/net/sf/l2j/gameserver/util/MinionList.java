...
public class MinionList {
    ...
    protected FastMap<Long, Integer> _respawnTasks = new FastMap<Long, Integer>().shared("MinionList._respawnTasks");
    ...
    public void maintainMinions() {
        ...
        if (_respawnTasks != null) {
            for (FastMap.Entry<Long, Integer> e = _respawnTasks.head(), end = _respawnTasks.tail(); (e = e.getNext()) != end;) {
                long deathTime = e.getKey(); // No typecast necessary.
    ...
    public void spawnSingleMinion(int minionid) {
        ...
        if (minionTemplate == null) {
            _log.warning("MinionList [WARNING]# spawnSingleMinion: " + minionid);
            return;
        }
