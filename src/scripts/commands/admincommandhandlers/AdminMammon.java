	...
	public boolean useAdminCommand(String command, L2PcInstance activeChar)
	{
		...
		else if (command.startsWith("admin_mammon_respawn"))
		{
			...
			if (merchSpawnInst!=null)
			{
				...
				activeChar.sendAdmResultMessage("The Merchant of Mammon will respawn in "+(merchRespawn/60000)+" minute(s).");
			}
			else
				activeChar.sendAdmResultMessage("Merchant of Mammon isn't registered for spawn.");
			if (blackSpawnInst!=null)
			{
				...
				activeChar.sendAdmResultMessage("The Blacksmith of Mammon will respawn in "+(blackRespawn/60000)+" minute(s).");
			}
			else
				activeChar.sendAdmResultMessage("Blacksmith of Mammon isn't registered for spawn.");
		}
...
/*
		...
		else if (command.startsWith("admin_msg"))
		{
			...
			{
				activeChar.sendAdmResultMessage("Command format: //msg <SYSTEM_MSG_ID>");
				return true;
			}
			activeChar.sendPacket(new SystemMessage.id(msgId));
		}*/
