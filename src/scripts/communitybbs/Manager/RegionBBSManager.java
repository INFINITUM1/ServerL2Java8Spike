...
public class RegionBBSManager extends BaseBBSManager
{
	...
	/* (non-Javadoc)
	 * @see scripts.communitybbs.Manager.BaseBBSManager#parsecmd(java.lang.String, net.sf.l2j.gameserver.model.actor.instance.L2PcInstance)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see scripts.communitybbs.Manager.BaseBBSManager#parsewrite(java.lang.String, java.lang.String, java.lang.String, java.lang.String, java.lang.String, net.sf.l2j.gameserver.model.actor.instance.L2PcInstance)
	 */
	@Override
		...
		if (ar1.equals("PM"))
		{
            ...
            try
            {
            			...
            			!BlockList.isBlocked(receiver, activeChar))
				{
            		...
            		{
            			SystemMessage sm = SystemMessage.id(SystemMessageId.THE_PERSON_IS_IN_MESSAGE_REFUSAL_MODE);
				...
				{
					SystemMessage sm = SystemMessage.id(SystemMessageId.S1_IS_NOT_ONLINE);
