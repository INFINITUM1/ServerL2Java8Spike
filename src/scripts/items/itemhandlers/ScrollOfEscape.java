...
public class ScrollOfEscape implements IItemHandler {
    ...
    public void useItem(L2PlayableInstance playable, L2ItemInstance item, boolean ctrl) {
        ...
        if (activeChar.isInsideCastleWaitZone() && (itemId == 1830 || itemId == 5859)) {
            activeChar.sendPacket(SystemMessage.sendString("Не доступно в данной момент."));
            return;
        }
            ...
            try {
                switch (_itemId) {
                    ...
                    case 7122:
                        ...
                        break;
                    case 7123:
                        _activeChar.teleToLocation(10827, -24158, -3645, false); // Gludio Castle Town -12678, 122776, -3116, true (update: Dyno island)
                        break;
                    case 7124:
