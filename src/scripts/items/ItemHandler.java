...
public class ItemHandler {
    ...
    public void useItem(L2PcInstance player, L2ItemInstance item, boolean ctrl, IItemHandler handler) {
        handler = _datatable.get(item.getItemId());
        if (handler == null) {
            return;
        }
        handler.useItem(player, item, ctrl);
    }
}
